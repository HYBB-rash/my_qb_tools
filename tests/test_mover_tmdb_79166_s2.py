...
def test_mover_tmdb_79166_s2_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文简体
            "碧蓝之海.S02E01.1080p.mkv": True,
            # 中文繁体
            "碧藍之海.S02E02.1080p.mkv": True,
            # 英文（常见做种命名）
            "Grand.Blue.S02E03.mkv": True,
            # 英文（带 Dreaming）
            "Grand Blue Dreaming - S02E04.mkv": True,
            # 日文（拓展匹配）
            "ぐらんぶる - S02E05.mkv": True,
            # 其他剧名
        ...
        mover = factory.create("tmdb-79166-s2")
        mover(src, dst)
