...
def test_mover_tmdb_278196_s1_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文
            "光死去的夏天.S01E01.1080p.mkv": True,
            # 中文变体（夏日）
            "光死去的夏日.S01E02.1080p.mkv": True,
            # 日文
            "光が死んだ夏.S01E03.1080p.mkv": True,
            # 英文
            "The Summer Hikaru Died - S01E04.mkv": True,
            # 罗马字（Hikari）
            "Hikari ga Shinda Natsu - S01E05.mkv": True,
            # 罗马字（Hikaru）
            "Hikaru ga Shinda Natsu - S01E06.mkv": True,
            # 其他剧名
        ...
        mover = factory.create("tmdb-278196-s1")
        mover(src, dst)
