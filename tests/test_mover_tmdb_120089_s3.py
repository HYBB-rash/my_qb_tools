...
def test_mover_tmdb_120089_s3_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文常见命名
            "间谍过家家.S03E01.1080p.mkv": True,
            "間諜過家家 第三季 02.mkv": True,
            # 英文常见命名（含 x/× 与 Season 表达）
            "Spy.x.Family.S03E03.mkv": True,
            "SPY×FAMILY - Season 3 Episode 04.mkv": True,
            "SPY_X_FAMILY.3rd.Season.E05.mkv": True,
            # 日文常见命名
            "スパイファミリー 第3期 05.mkv": True,
            # 不应匹配：其他季/剧场版等
        ...
        mover = factory.create("tmdb-120089-s3")
        mover(src, dst)
