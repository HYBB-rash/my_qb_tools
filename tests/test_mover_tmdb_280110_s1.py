...
def test_mover_tmdb_280110_s1_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文（简体/繁体）简称
            "正义使者.S01E01.1080p.mkv": True,
            "正義使者.S01E02.1080p.mkv": True,
            # 中文全名（简体/繁体）
            "我的英雄学院之非法英雄.S01E03.mkv": True,
            "我的英雄學院之非法英雄.S01E04.mkv": True,
            # 英文常见命名
            "My.Hero.Academia.Vigilantes - S01E05.mkv": True,
            "My Hero Academia - Illegals S01E06.mkv": True,
            # 日文常见命名
            "ヴィジランテ-僕のヒーローアカデミア ILLEGALS - 07.mkv": True,
            # 不应匹配：本篇/泛用词
            "我的英雄学院.S01E01.mkv": False,
            "Vigilantes.S01E01.mkv": False,
        ...
        mover = factory.create("tmdb-280110-s1")
        mover(src, dst)
