...
def test_mover_tmdb_246862_s1_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文（带中点）
            "新·吊带袜天使.S01E01.1080p.mkv": True,
            # 中文（无中点）
            "新吊带袜天使.S01E02.1080p.mkv": True,
            # 英文（& 和 with Garterbelt）
            "Panty & Stocking with Garterbelt - S01E03.mkv": True,
            # 英文（and，不带 with Garterbelt）
            "Panty and Stocking - S01E04.mkv": True,
            # 仅“吊带袜天使”——旧版命名，应排除
            "吊带袜天使.S01E10.1080p.mkv": False,
            # 其他剧名
        ...
        mover = factory.create("tmdb-246862-s1")
        mover(src, dst)
