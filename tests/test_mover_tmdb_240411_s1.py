...
def test_mover_tmdb_240411_s1_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文
            "胆大党.S01E01.1080p.mkv": True,
            # 日文
            "ダンダダン.S01E02.1080p.mkv": True,
            # 英文（带空格）
            "DAN DA DAN - S01E03.mkv": True,
            # 英文（连写）
            "Dandadan - S01E04.mkv": True,
            # 其他剧名
        ...
        mover = factory.create("tmdb-240411-s1")
        mover(src, dst)
