...
def test_mover_tmdb_271649_s1_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文简繁体
            "琉璃的宝石.S01E01.1080p.mkv": True,
            "琉璃的寶石 - 02.mkv": True,
            # 日文别名
            "瑠璃の宝石_E03.mkv": True,
            "瑠璃ノ宝石-04.mkv": True,
            # 英文别名
            "Ruri.no.Houseki.S01E05.mkv": True,
            "Ruri's.Jewels.E06.mkv": True,
            # 不应匹配
            "宝石之国.S01E01.mkv": False,
            "Ruri Jewelers.E01.mkv": False,
        }

        for name, _ in cases.items():
            (src / name).write_text("x", encoding="utf-8")

        mover = factory.create("tmdb-271649-s1")
        mover(src, dst)
