...
def test_mover_tmdb_272059_s1_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文（简体，无分隔符）
            "凸变英雄X.S01E01.1080p.mkv": True,
            # 中文（繁体，无分隔符）
            "凸變英雄X.S01E02.1080p.mkv": True,
            # 带连接符/空格分隔的变体
            "凸变英雄-X.S01E03.mkv": True,
            "凸變英雄 X.S01E04.mkv": True,
            # 非本剧
        ...
        mover = factory.create("tmdb-272059-s1")
        mover(src, dst)
