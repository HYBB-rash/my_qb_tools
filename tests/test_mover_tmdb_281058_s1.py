...
def test_mover_tmdb_281058_s1_links_expected_files():
    with tempfile.TemporaryDirectory() as td:
        ...
        cases = {
            # 中文（带中点）
            "沉默·魔女.S01E01.1080p.mkv": True,
            # 中文（无中点，简称）
            "沉默魔女.S01E02.1080p.mkv": True,
            # 中文（副标题）
            "沉默魔女的秘密 - S01E03.mkv": True,
            # 英文
            "Silent Witch - S01E04.mkv": True,
            # 其他剧名
        ...
        mover = factory.create("tmdb-281058-s1")
        mover(src, dst)
